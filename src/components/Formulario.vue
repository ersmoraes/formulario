                ...
                <form @reset.prevent="resetar()">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            ...
                            <small class="text-muted">Formato: 00.000.000/00000-00</small>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            ...
                            <small class="text-muted">Formato: ASD-1234</small>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        <label class="col-3 col-form-label">Avalicação:</label>
                        <div class="col">
            ...
            <div class="col-6 text-white bg-secondary">
                ...
                <div class="mb-3 row">
                    ...
                    <ul>
                        ...
                        <br>
                        <li>{{ $moment(form.dataHoraLocal).subtract(10, 'days').format('LLLL') }}</li>
                        <li>{{ $moment(form.dataHoraLocal).subtract(1, 'months').format('LLLL') }}</li>
                ...
                <div class="mb-3 row">
                    <span>Avaliação: {{form.avaliacao}} Estrelas</span>
                </div>
            </div>
        </div>
...
export default {
    ...
    data: () => ({
        cursos: [
            ...
            {
                id: 4,
                curso: 'Curso Completo de Desenvolvedor NodeJS e MongoDB'
            }
        ],
        form: {},
        formEstadoInicial: {
